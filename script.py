...
for row in daily_transactions:
  ...
  daily_transactions_split.append(split_row) 
...
for color in colors:
  message = "Thread Shed sold {} threads of {} today.".format(color_count(color), color)
  print(message)
